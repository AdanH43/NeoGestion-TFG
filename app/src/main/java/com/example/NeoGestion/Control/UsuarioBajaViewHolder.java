...
public class UsuarioBajaViewHolder extends RecyclerView.ViewHolder {
    final UsuarioBajaAdapter myadapter;
    ...
    public UsuarioBajaViewHolder(@NonNull View itemView, UsuarioBajaAdapter myadapter) {
        super(itemView);
